...
@Component({
  ...
  templateUrl: './patient-chatbot.component.html',
  styleUrls: ['./patient-chatbot.component.css']
})
export class PatientChatbotComponent implements OnInit, AfterViewChecked {
